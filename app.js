...
function portrait(p,detail=false){const key=portraits[p[0]];return key?'<img class="'+(detail?'detail-portrait':'card-portrait')+'" src="assets/'+key+'.webp?v=restored-7" alt="'+p[0]+'" loading="lazy" decoding="async" width="1632" height="1232">':'';}
...
function beastImage(b,detail=false){const key=beastArt[b[0]];return key?'<img class="'+(detail?'detail-portrait':'beast-image')+'" src="assets/'+key+'.webp?v=restored-7" alt="'+b[0]+'의 모습" loading="lazy" decoding="async" width="1632" height="1232">':'';}
